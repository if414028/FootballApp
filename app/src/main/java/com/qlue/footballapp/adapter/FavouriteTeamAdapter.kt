...
class FavouriteTeamAdapter(val teamList: List<Team>, val context: Context?) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavouriteTeamViewHolder {
        return FavouriteTeamViewHolder(LayoutInflater.from(context).inflate(R.layout.grid_team_item, parent, false))
    }
    ...
    inner class FavouriteTeamViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(team: Team) {
